...
// @Success 200 {object} response.SuccessResponse{data=[]models.ServiceContainer} "List of service containers"
// @Failure 400 {object} response.ErrorResponse "Team access denied or service not found"
// @Failure 401 {object} response.ErrorResponse "User not authenticated"
// @Failure 500 {object} response.ErrorResponse "Internal server error"
// @Router /teams/{teamID}/projects/{projectID}/services/{serviceID}/containers [get]
// @Security BearerAuth
func (h *ServiceHandler) GetContainers(w http.ResponseWriter, r *http.Request) {
	// Get URL parameters
	...
	// Return containers
	response.RespondWithJSON(w, http.StatusOK, containers)
}