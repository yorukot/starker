            ...
            <div class="grid gap-4 py-4">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    {#if $errors.description}
                        <span class="col-span-3 text-sm text-destructive"
           ...
           {$errors.privateKey ? 'border-destructive' : ''}"
                ...
                {#if generatedPublicKey}
                    <Alert.Root>
                        <LucideNotebookPen />
                        <Alert.Title
                            >Run this command on your server to authorize the key:</Alert.Title
                        >
                        <Alert.Description>
                ...
                {:else}
                    <Alert.Root>
                        ...
                        <Alert.Description>
                            You need to add your public key to the server's ~/.ssh/authorized_keys
                            file
                        </Alert.Description>
                    </Alert.Root>
                {/if}
