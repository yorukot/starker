<script lang="ts">
    ...
    function selectCompose() {
        goto(
            `/dashboard/${page.params.teamID}/projects/${page.params.projectID}/services/new/compose`
        );
    }
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                ...
                >
                    ...
                    <Card.Content>
                        <div class="space-y-2">
                            <p class="text-sm text-muted-foreground">
                                Clone a Git repository and automatically extract Docker Compose
                                configurations with real-time progress tracking.
                            </p>
                        </div>
                    </Card.Content>
                </Card.Root>
                ...
                >
                    ...
                    <Card.Content>
                        <div class="space-y-2">
                            <p class="text-sm text-muted-foreground">
                                Deploy applications using Docker Compose with multiple containers,
