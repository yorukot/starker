    ...
    {:else if service}
        ...
        <Card.Root class="border-destructive">
            <Card.Header>
                ...
                <Card.Description
                    >Irreversible and destructive actions for this service</Card.Description
                >
            </Card.Header>
            <Card.Content class="space-y-4">
                <div class="rounded-lg border border-destructive/20 bg-destructive/5 p-4">
                    ...
                    <p class="mb-3 text-sm text-muted-foreground">
                        Once you delete a service, there is no going back. This will permanently
                        delete the service, stop all containers, and remove all associated data.
                    </p>
                    <Button
                        variant="destructive"
