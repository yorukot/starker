<script lang="ts">
    ...
    const selectedContainerName = $derived(
        selectedContainer?.container_name || 'Select a container'
    );
    ...
    {:else}
        ...
        {#if containers.length === 0}
            <Alert.Root>
                ...
                <Alert.Description>
                    This service doesn't have any containers yet. Containers will appear here once
                ...
                <Card.Content class="space-y-4">
                                            ...
                                            <div class="flex flex-col">
                                                ...
                                                <div class="text-xs text-muted-foreground">
                                                    ...
                                                    {#if container.container_id}
                                                        " ID: {container.container_id.slice(
                                                            0,
                                                            12
                                                        )}...
                                                    {/if}
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div class="flex items-center space-x-2">
                            ...
                            <Label for="timestamps" class="cursor-pointer text-sm"
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <Label for="follow" class="cursor-pointer text-sm"
                                >Follow log output</Label
                            >
                        </div>

                        <div class="flex items-center space-x-2">
                            <Checkbox id="tail" bind:checked={includeTail} />
                            <Label for="tail" class="cursor-pointer text-sm"
                                >Show recent lines:</Label
                            >
                            <Input
                                type="number"
