            ...
            {#if services.length > 0}
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 2xl:grid-cols-3">
                    {#each services as service (service.id)}
                        <a
                            href="/dashboard/{page.params
                                .teamID}/projects/{project.id}/services/{service.id}"
                            class="block"
                        >
                            <Card.Root
                                ...
                                <Card.Header>
                                    <div class="flex flex-col space-y-3">
                                        <div class="flex items-center gap-2">
                                            <div
                                                class="rounded-lg border border-primary/20 bg-primary/10 p-2"
                                            >
                                        ...
                                        <div class="space-y-1 text-sm text-muted-foreground">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <span
                                                    class="{getStateColor(
                                                        service.state
                                                    )} font-medium capitalize">{service.state}</span
                                                >
                                            </div>
                                            <div class="flex items-center gap-2">
                ...
                <div class="flex w-full flex-col items-center justify-center gap-6 py-20">
                    ...
                    <div class="space-y-2 text-center">
                        ...
                        <p class="max-w-sm text-sm text-muted-foreground">
                            Get started by adding your first service to deploy and manage in this
                            project.
                        </p>
                    </div>
                    <Button
