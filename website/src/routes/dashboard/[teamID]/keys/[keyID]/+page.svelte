...
<div class="flex flex-col gap-6">
    ...
    {:else if privateKey}
        ...
        <form use:form class="space-y-6">
            ...
            <!-- Fingerprint Section -->
            <div class="space-y-2">
                <label class="text-sm font-medium text-foreground" for="public-key"
                    >Fingerprint</label
                >
                <div class="relative">
                    <div
            ...
            <div class="space-y-2">
                <div class="flex items-center justify-between">
                    <label class="text-sm font-medium text-foreground" for="private-key"
                        >Private Key *</label
                    >
                </div>
                <div class="relative">
                    <Textarea
                        ...
                        class="min-h-[120px] font-mono text-xs {$errors.privateKey
                            ? 'border-destructive'
                            : ''}"
                        required
                    />
